...
| RPi 4 | ONNX | — | **крэш** | — |
| **RPi 5 (XL6019E1, 4 cores)** | **NCNN (плавный старт)** | **89** | **11.2** | **10.2x** |
...
- **RPi 5 с NCNN 4 cores — 11.2 FPS** — лучший результат на RPi (XL6019E1, плавный старт)
...
- blackops GPU быстрее RPi 5 в **28x** (314.8 vs 11.2 FPS)
