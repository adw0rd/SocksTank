...
### Инференс YOLO (64-bit ОС, 4 ядра, лаб. БП 5.1V)

| Формат | Mean (ms) | Min (ms) | Max (ms) | FPS | vs RPi 4 |
|---|---|---|---|---|---|
| NCNN | 68 | 68 | 69 | **14.6** | **6.1x** |
| ONNX | 146 | 143 | 153 | **6.8** | — |
| PyTorch | 288 | 285 | 298 | **3.5** | **3.2x** |

Температура: 48→64°C (без радиатора), throttled=0x0.
